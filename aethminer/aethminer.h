...
// blago version
#ifdef __AVX512F__
	char const *const version = "v1.190921.2_AVX512";
#else
#ifdef __AVX2__
	char const *const version = "v1.190921.2_AVX2";
#else
	#ifdef __AVX__
		char const *const version = "v1.190921.2_AVX";
	#else
			char const *const version = "v1.190921.2_SSE";
		//	char const *const version = "v1.190921.2";
	#endif
#endif 
#endif 
